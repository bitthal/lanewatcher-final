...
function Settings({}) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 my-3 mr-3 mt-32">
      <div className="w-fit-content lg:w-1/3">
        {drpdwnVaue && (
          <div className="mt-3">
            <label>
              <h1>
            ...
            <button
              className="bg-[#434190] w-24 rounded-md text-white text-xs h-8 mt-2 lg:mt-2"
        ...
        <button
          className="mt-3 lg:mt-4 bg-transparent hover:bg-[#2a2e67] text-indigo-700 font-semibold hover:text-white py-2 px-4 border border-indigo-500 hover:border-transparent rounded h-10"
          onClick={addFields}
        >
          Add
        </button>

        <div className={`${showAddField ? "opacity-1" : "opacity-0"} mt-3`}>
      ...
      <div className="w-fit-content lg:w-2/3">
        {!resetloading ? (
          <table className="w-full overflow-auto divide-y divide-gray-200 border rounded-lg">
            <thead className="bg-[#2a2e67] text-white">
              <tr>
                <th
                  scope="col"
                  className="px-6 py-3 text-xs text-center uppercase "
            ...
            <tbody className="divide-y divide-gray-200">
              {currentItems && currentItems.length > 0 && !resetloading ? (
                currentItems?.map((data, index) => {
                  return (
                    <tr key={index}>
                      <td className="text-sm text-center font-medium text-gray-800">
                        {index}
                      </td>
                      <td className="text-sm text-center font-medium text-gray-800">
                        {data.site_id}
                      ...
                      <td className="text-sm text-center font-medium text-left">
                        <button
