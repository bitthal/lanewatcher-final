  ...
  return (
    ...
    >
      ...
      <Image
        ...
        width={50}
        height={50}
        className="object-contain mt-10 ml-1"
      />
      </Link>
        ...
        <div className="flex flex-col mt-10">
          <div
            className={
              ...
              ? "cursor-pointer flex bg-indigo-800 items-center p-5 gap-2 inline"
              : "cursor-pointer flex items-center p-5 gap-2 inline"
            }
          >
            ...
            <Link href="/dashboard" className={`${!show ? "w-32" : ""}`}>
              ...
              {!show && (
                <span className= {router.pathname == "/dashboard" ? "text-white font-bold p-0.5 m-2" : "text-red-800 font-bold p-0.5 m-2"}>Dashboard</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          >
            ...
            <Link href="/shipment" className="">
              ...
              {!show && (
                <span className={router.pathname == "/shipment" ? "text-white font-bold p-0.5 m-2" : "text-red-800 font-bold p-0.5 m-2"}>Shipment</span>
              )}
            </Link>
          ...
          >
            ...
            <Link href="/tracker" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className={router.pathname == "/tracker" ? "text-white font-bold p-0.5 m-2" : "text-red-800 font-bold p-0.5 m-2"}>Tracker</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          >
            ...
            <Link href="/settings" className={`${!show ? "w-auto" : "w-auto"}`}>
              ...
              {!show && (
                <span className={router.pathname == "/settings" ? "text-white font-bold p-0.5 m-2" : "text-red-800 font-bold p-0.5 m-2"}>Settings</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          >
            ...
            <Link href="/alerts" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className={router.pathname == "/alerts" ? "text-white font-bold p-0.5 m-2" : "text-red-800 font-bold p-0.5 m-2"}>Alerts</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          >
            ...
            <Link href="/analysis" className={`${!show ? "w-32 " : "w-auto "}`}>
              ...
              {!show && (
                <span className={router.pathname == "/analysis" ? "text-white font-bold p-0.5 m-2" : "text-red-800 font-bold p-0.5 m-2"}>Analysis</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          >
            ...
            <Link href="/support" className={`${!show ? "w-32 " : "w-auto "}`}>
              ...
              {!show && (
                <span className={router.pathname == "/support" ? "text-white font-bold p-0.5 m-2" : "text-red-800 font-bold p-0.5 m-2"}>Support</span>
              )}
            </Link>
            </Tooltip>
          </div>
