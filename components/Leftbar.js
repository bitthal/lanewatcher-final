...
export default function Leftbar({ show }) {
  ...
  return (
    <div
      className={`h-auto ease-in-out duration-300 bg-indigo-900 ${
        ...
        <div className="flex flex-col mt-10">
          <div
            className={
              ...
              ? "cursor-not-allowed flex bg-indigo-700 items-center p-5 rounded-xl gap-2 m-1 inline"
          ...
          >
            ...
            <Link href="/dashboard" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Dashboard</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          >
            ...
            <Link href="/shipment">
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Shipment</span>
              )}
            </Link>
          ...
          <div
            className={
              router.pathname == "/tracker"
                ? "cursor-pointer flex bg-indigo-700 items-center p-5 rounded-xl gap-2 m-1 inline tooltip"
                : "cursor-pointer flex items-center p-5 rounded-xl gap-2 m-1 inline"
            }
          >
            ...
            <Link href="/tracker" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Tracker</span>
              )}
            </Link>
            </Tooltip>
          </div>
          <div
            className={
              router.pathname == "/settings"
                ? "cursor-pointer flex bg-indigo-700 items-center p-5 rounded-xl gap-2 m-1 inline"
                : "cursor-pointer flex items-center p-5 rounded-xl gap-2 m-1 inline"
            }
          >
            ...
            <Link href="/settings" className={`${!show ? "w-auto" : "w-auto"}`}>
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Settings</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          >
            ...
            <Link href="/alerts" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Alerts</span>
              )}
            </Link>
            </Tooltip>
          </div>
          <div
            className={
              router.pathname == "/messages"
                ? "cursor-pointer flex bg-indigo-700 items-center p-5 rounded-xl gap-2 m-1 inlinee"
                : "cursor-pointer flex items-center p-5 rounded-xl gap-2 m-1 inline"
            }
          >
            ...
            <Link href="/messages" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Messages</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          >
            ...
            <Link href="/analysis" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Analysis</span>
              )}
            </Link>
            </Tooltip>
          </div>
          ...
          <div
            className={
              router.pathname == "/support"
                ? "flex items-center bg-indigo-700  gap-2 p-5 cursor-not-allowed inline"
                : "cursor-pointer flex items-center p-5 rounded-xl gap-2 m-1 inline"
            }
          >
            ...
            <Link href="/support" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Support</span>
              )}
            </Link>
            </Tooltip>
          </div>

          <div className="cursor-pointer flex items-center p-5 rounded-xl gap-2 m-1 inline">
          <Tooltip message="Logout">
            <Link href="/logout" className={`${!show ? "w-32" : "w-auto"}`}>
              ...
              {!show && (
                <span className="text-white font-bold p-0.5 m-2">Logout</span>
              )}
            </Link>
            </Tooltip>
          </div>
